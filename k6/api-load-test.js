...
// Cross-check of ApiLoadSimulation.java (Gatling)
const BASE_URL = __ENV.BASE_URL || 'https://api-staging.gauthierfitness.fr';

export const options = {
    stages: [{duration: '10s', target: 20}, {duration: '20s', target: 20},], thresholds: {
        http_req_duration: ['p(95)<300'], http_req_failed: ['rate<0.01'],
    },
};

const params = {
    headers: {
        Accept: 'application/json', 'X-Guest-Cart-Token': 'k6-load-test',
    },
};
