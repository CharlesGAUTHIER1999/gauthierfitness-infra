#!/usr/bin/env bash
# ════════════════════════════════════════════════════════════════════
#  GauthierFitness - Monthly restore test
#  never on a VPS
#  Usage: ./restore-db-test.sh <staging|production>
#  Requirements: awscli, gpg (private key backup@gauthierfitness.fr imported), docker
# ════════════════════════════════════════════════════════════════════
set -euo pipefail
...
# Backup filenames tagged with VPS hostname
case "$TARGET" in
